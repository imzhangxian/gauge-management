...
const resources = {
    en: {
        translation: {
            ...
            'title.task': 'Task',
            'label.task_not_found': 'No Task yet',
            'button.create_order': 'Create Workorder',
            'title.workorder': 'Work orders', 
            'dialog.title.create_workorder': 'Create Work order', 
            'label.workorder_not_found': 'No Work Order yet',
